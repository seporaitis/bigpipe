...
* http://github.com/seporaitis/openpipe
...
* Open [http://localhost/openpipe/examples/] with a browser (I've tested with latest Chrome) and you should see two files there:
